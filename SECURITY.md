...
| `cap_add: SYS_ADMIN` | `stacks/flaresolverr/docker-compose.yml` | Required for Chromium internal sandbox; without it must pass `--no-sandbox` which reduces isolation further |
